...
extension TransactionUIExtensions on TransactionModel {
  ...
  String get formattedAmount {
    ...
    // Đảm bảo amount là double (nếu là int thì ép kiểu)
    final doubleAmount = amount is int ? amount.toDouble() : amount;
    return '$amountPrefix${currencyFormatter.format(amount.toDouble())}';
  }
