...
class _CustomKeyboardState extends State<CustomKeyboard> {
  final NumberFormat _numberFormat = NumberFormat("#,##0.###", "en_US"); // Đảm bảo chỉ truyền BigInt vào format nếu dùng kiểu này
  ...
  void _formatAndSetText(String input) {
    ...
    if (value != null) {
      ...
      String formattedText = _numberFormat.format(BigInt.from(value.toInt()));
